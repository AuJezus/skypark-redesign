...
function Navigation() {
  ...
  return (
    <nav
      ...
      } fixed left-0 top-0 z-50 flex w-full flex-col justify-between px-3 py-2 transition-transform duration-500 md:flex-row md:items-center md:px-6 md:py-3`}
    >
      ...
      <ul
        ...
        } fixed left-0 top-0 z-40 flex h-screen w-full flex-col items-center justify-center gap-24 bg-primary font-nunito text-4xl uppercase underline transition-transform duration-500 md:relative md:h-fit md:w-auto md:flex-row md:gap-4 md:bg-transparent md:text-base md:no-underline`}
      >
